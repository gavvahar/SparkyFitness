...
const { getLogs, getLogSummary, getCaptureLevel, getViewFilter } =
  jest.requireMock('../../src/services/LogService');
const { loadLastSyncedTime, loadBackgroundSyncEnabled, loadTimeRange } =
  jest.requireMock('../../src/services/storage');
