...
describe('workoutFormReducer', () => {
  describe('RESTORE_DRAFT', () => {
    it('replaces entire state with the provided draft', () => {
      ...
      const result = workoutFormReducer(initial, {
        type: 'RESTORE_DRAFT',
        draft: restoredDraft,
      });
  ...
  describe('ADD_EXERCISE', () => {
    ...
    it('preserves existing exercises', () => {
      ...
      let result = workoutFormReducer(state, {
        type: 'ADD_EXERCISE',
        exercise: ex1,
        exerciseClientId: 'ecid-1',
        setClientId: 'scid-1',
  ...
  describe('SET_EXERCISE_REST', () => {
    it('updates restTime for every set of the targeted exercise', () => {
      ...
      expect(result.exercises[0].sets.map(s => s.restTime)).toEqual([
        180, 180, 180,
      ]);
    });
      ...
      const state: WorkoutDraft = {
        ...
        exercises: [
          ...
          },
          {
            ...
            exerciseCategory: null,
            sets: [
              { clientId: 'set-2', weight: '200', reps: '5', restTime: 90 },
            ],
          },
        ],
      };
        ...
        exercises: [
          {
            ...
            exerciseCategory: null,
            sets: [
              { clientId: 'set-1', weight: '225', reps: '5', restTime: 90 },
            ],
          },
        ],
      };
