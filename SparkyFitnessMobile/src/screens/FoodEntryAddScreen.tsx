...
const FoodEntryAddScreen: React.FC<FoodEntryAddScreenProps> = ({
  ...
  return (
    ...
    >
            ...
            {activeItem.source === 'external' && (
              ...
              >
                {isSavePending || isCreateVariantPending ? (
                  ...
                  <Icon name="bookmark" size={22} color={accentColor} />
                )}
              </TouchableOpacity>
            )}
          </View>
      ...
      <ScrollView
        className="flex-1"
        contentContainerClassName="px-4 pt-4 pb-safe-or-4 gap-4"
      >
                ...
                <BottomSheetPicker
                  ...
                  renderTrigger={({ onPress }) => (
                    ...
                    >
                      <Text className="text-text-secondary text-sm">
                        {' \u00b7 '}
                        {displayValues.servingSize} {displayValues.servingUnit}{' '}
                        per serving
                      </Text>
